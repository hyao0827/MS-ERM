...
class EEGNet(nn.Module):
    ...
    def __init__(self, num_class=2,
        ...
        for (out_channel, kernel_width, s) in zip(hidden_size, kernel_size, stride):
            pad = (3 - 1) // 2
            self.projections.append(nn.Conv2d(in_channel, out_channel, kernel_size=1, stride=s, bias=False)
        ...
        self.predict1 = nn.Linear(hidden_size[-1]*18, self.num_class, bias=True)
