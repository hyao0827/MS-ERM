...
def train(args, data_train, label_train, data_val, label_val, subject, fold):
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=args.learning_rate, weight_decay=0.06)
    ...
    for epoch in range(1, args.max_epoch + 1):
        ...
        print('epoch {}_train: loss={:.4f} acc={:.4f} f1={:.4f}'
        ...
        print('epoch {}_val: loss={:.4f} acc={:.4f} f1={:.4f}'.
    ...
    return trlog['max_acc'], trlog['train_loss']
