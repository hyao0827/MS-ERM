...
import time
import pprint
from modelllist.TSception import TSception
from modelllist.MT_timenets import MT_timenets
from modelllist.MLP import MLP
from modelllist.eegnet import EEGNet
from modelllist.lstm import EEGLSTM
from modelllist.LogisticRegression import LogisticRegression
...
def get_model(args):
    ...
    elif args.model == 'MT_timenets':
        model = MT_timenets(args)
    elif args.model == 'MLP':
        model = MLP(288, 1024, 2, 0.4, 'relu')
    elif args.model == 'LogisticRegression':
        model = LogisticRegression(288, 2)
